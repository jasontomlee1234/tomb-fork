...
const tAddr = "0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101";

const poolTokens = [
  ["0xB7ddC6414bf4F5515b52D8BdD69973Ae205ff101", 20, 0], //WOOL
...
async function main() {
  ...
  const startTime = 16452720000; //Saturday, 19 February 2022 20:00:00 GMT+08:00

  const factoryAddr = "0xd27d9d61590874bf9ee2a19b27e265399929c9c3";
  const routerAddr = "0xa4EE06Ce40cb7e8c04E127c1F7D3dFB7F7039C81";

  const factory = new ethers.Contract(factoryAddr, uniFactory.abi);
  const router = new ethers.Contract(routerAddr, uniRouter.abi);
  const wdoge = new ethers.Contract(tAddr, erc20.abi);
  ...
  await (
    await wdoge
      .connect(signer)
      .approve(routerAddr, "999999999999999999999999999999")
  ).wait();
